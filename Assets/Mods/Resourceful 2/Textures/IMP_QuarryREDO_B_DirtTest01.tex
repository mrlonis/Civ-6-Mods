...
<AssetObjects::TextureInstance>
	...
	<m_SourceFilePath text="//civ6/main/ArtDev/Buildings/Improvements/Quarry/03_Texture/REDO/IMP_QuarryREDO_B_DirtTest01.tga"/>
	<m_SourceObjectName text=""/>
	<m_ImportedTime>0</m_ImportedTime>
	<m_ExportedTime>700670282</m_ExportedTime>
	<m_ClassName text="Generic_BaseColor"/>
	<m_DataFiles>
		<Element>
			<m_ID text="DDS"/>
			<m_RelativePath text="IMP_QuarryREDO_B_DirtTest01.dds"/>
		</Element>
	</m_DataFiles>
	<m_Name text="IMP_QuarryREDO_B_DirtTest01"/>
	<m_Description text=""/>
	<m_Tags>
