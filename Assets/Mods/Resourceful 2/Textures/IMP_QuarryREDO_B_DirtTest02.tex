...
<AssetObjects::TextureInstance>
	...
	<m_SourceFilePath text="//civ6/main/ArtDev/Buildings/Improvements/Quarry/03_Texture/REDO/IMP_QuarryREDO_B_DirtTest02.tga"/>
	<m_SourceObjectName text=""/>
	<m_ImportedTime>0</m_ImportedTime>
	<m_ExportedTime>694382986</m_ExportedTime>
	<m_ClassName text="Generic_BaseColor"/>
	<m_DataFiles>
		<Element>
			<m_ID text="DDS"/>
			<m_RelativePath text="IMP_QuarryREDO_B_DirtTest02.dds"/>
		</Element>
	</m_DataFiles>
	<m_Name text="IMP_QuarryREDO_B_DirtTest02"/>
	<m_Description text=""/>
	<m_Tags>
