...
local function RefreshGUI(selectedPlayerId, unitId)
    ...
    --end
    if ExposedMembers.MOD_Cheat_Menu_Units.UiRefreshUnitPanel ~= nil then
...
local function LookAtPlot(selectedPlayerId, unitId)
    if ExposedMembers.MOD_Cheat_Menu_Units.LookAtPlot ~= nil then
        ExposedMembers.MOD_Cheat_Menu_Units.LookAtPlot(selectedPlayerId, unitId);
    end
end
...
local function IsDestinationReached(PlayerID, UnitID)
    if PlayerID ~= nil and UnitID ~= nil and Players[PlayerID] ~= nil and Players[PlayerID]:IsHuman() then
        ...
        if unit ~= nil then 
            local unitMovesRem, queuedEndPlotId = ExposedMembers.MOD_Cheat_Menu_Units.GetUnitMovesFromUI(PlayerID, UnitID);
        ...
        if cId ~= nil then
            ...
            if unit ~= nil and Players[playerId]:IsHuman() then
                if autorestoreAttack then 
                    ...
                    local unitMovesRem = ExposedMembers.MOD_Cheat_Menu_Units.GetUnitMovesFromUI(playerId, unitId);
...
local function OnMovementComplete(PlayerID, UnitID, x, y)
    if autorestoreMove and PlayerID ~= nil and UnitID ~= nil and Players[PlayerID] ~= nil and Players[PlayerID]:IsHuman() then
        ...
        if unit ~= nil then 
                UnitManager.RestoreMovement(unit);
                --ExposedMembers.MOD_Cheat_Menu_Units.RequestDelayedMovementCheat();
                UnitManager.ChangeMovesRemaining(unit, targetMovePoints);

                if not IsDestinationReached(PlayerID, UnitID) then 
                    -- destination was not reached
                    LookAtPlot(PlayerID, UnitID);
                    ExposedMembers.MOD_Cheat_Menu_Units.UiRefreshSelection( PlayerID, UnitID );
                end
                --if queuedEndPlotId then
...
local function OnCheatMovement(selectedPlayerId, unitId, disableRefreshRequest)
    ...
    if unit ~= nil and Players[selectedPlayerId]:IsHuman() then
        local unitMovesRem = ExposedMembers.MOD_Cheat_Menu_Units.GetUnitMovesFromUI(selectedPlayerId, unitId);
        ...
        elseif not autorestoreMove and prevCheatMoveUnit ~= nil and prevCheatMovePoints ~= nil then
            ...
            unitMovesRem = ExposedMembers.MOD_Cheat_Menu_Units.GetUnitMovesFromUI(selectedPlayerId, prevCheatMoveUnit);
...
--******************************************************************************
function Initialize()
    print( " ###################################### Initializing Mod Cheat Menu - Units Base Script... ################################################ " );
    ...
    if ( not ExposedMembers.MOD_Cheat_Menu_Units) then ExposedMembers.MOD_Cheat_Menu_Units = {}; end
    ExposedMembers.MOD_Cheat_Menu_Units.OnCheatHeal = OnCheatHeal;
    ExposedMembers.MOD_Cheat_Menu_Units.OnDuplicate = OnDuplicate;
    ExposedMembers.MOD_Cheat_Menu_Units.OnCheatMovement = OnCheatMovement;
    ExposedMembers.MOD_Cheat_Menu_Units.OnCheatPromote = OnCheatPromote;
    ExposedMembers.MOD_Cheat_Menu_Units.OnCheatAttack = OnCheatAttack;
        
    ExposedMembers.MOD_Cheat_Menu_Units.GetAutorestoreAttack = GetAutorestoreAttack;
    ExposedMembers.MOD_Cheat_Menu_Units.ChangeAutorestoreAttack = ChangeAutorestoreAttack;
    ExposedMembers.MOD_Cheat_Menu_Units.GetAutorestoreHealth = GetAutorestoreHealth;
    ExposedMembers.MOD_Cheat_Menu_Units.ChangeAutorestoreHealth = ChangeAutorestoreHealth;
    ExposedMembers.MOD_Cheat_Menu_Units.GetAutorestoreMove = GetAutorestoreMove;
    ExposedMembers.MOD_Cheat_Menu_Units.ChangeAutorestoreMove = ChangeAutorestoreMove;
    ExposedMembers.MOD_Cheat_Menu_Units.GetAutorestorePromo = GetAutorestorePromo;
    ExposedMembers.MOD_Cheat_Menu_Units.ChangeAutorestorePromo = ChangeAutorestorePromo;
    ExposedMembers.MOD_Cheat_Menu_Units.ApplyAutorestoreMovementCheat = ApplyAutorestoreMovementCheat;
    ExposedMembers.MOD_Cheat_Menu_Units_Initialized = true;
